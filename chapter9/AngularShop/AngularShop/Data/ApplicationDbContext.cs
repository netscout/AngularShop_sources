...
namespace AngularShop.Data
{
    public class ApplicationDbContext : IdentityDbContext<User, Role, long>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //OrderStatus enum 타입의 필드를 DB에는 int타입으로 저장
            modelBuilder.Entity<Order>()
                .Property(o => o.OrderStatusId).HasConversion<int>();

            //OrderStatus enum 타입의 요소들을 DB에 생성
            var orderStatusEntity = modelBuilder.Entity<OrderStatus>();
            orderStatusEntity
                .Property(o => o.Id).HasConversion<int>();
            orderStatusEntity
                .HasData(
                    Enum.GetValues(typeof(OrderStatusId))
                        .Cast<OrderStatusId>()
                        .Select(osi => new OrderStatus
                        {
                            Id = osi,
                            Name = osi.ToString()
                        }));
